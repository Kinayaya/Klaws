...
const DEFAULTS = {
  ...
  links: [{id:1,from:3,to:4,rel:'link',color:'#6F86A0'},{id:2,from:3,to:2,rel:'link',color:'#6F86A0'},{id:3,from:1,to:5,rel:'link',color:'#6F86A0'}],
...
const RELATION_TYPE_META = {
  link:{label:'link',color:LINK_COLOR}
};
